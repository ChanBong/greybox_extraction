...
train_kinetics = datasets.Kinetics("../k400val_dummy", frames_per_clip= 16, split='train', num_classes= '400', step_between_clips= 200000, transform = train_transform,  download= False, num_download_workers= 1, num_workers= 80)
