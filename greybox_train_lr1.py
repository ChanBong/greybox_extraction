...
train_kinetics = datasets.Kinetics("../k400val_pytorch", frames_per_clip= 32, split='val', num_classes= '400', step_between_clips= 20000, transform = train_transform,  download= False, num_download_workers= 1, num_workers= 80)
